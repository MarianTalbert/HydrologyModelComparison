...
source("C:\\Users\\mtalbert\\Desktop\\HydrologyProblem\\HydroCode\\ImagePlot.R")
source("C:\\Users\\mtalbert\\Desktop\\HydrologyProblem\\HydroCode\\RasterConvert.R")
...
for(v in 1:length(Vars)){
    ...
    CandidaData<-"E:\\ClimateCache\\SatelliteSWE\\SWE_monthly_CONUS_12km_1987-2003.nc"
